                ...
                query(DDL_CHECK_TABLE, ['brtc_role_permission'], errCallback, function (result) {
                    if (result.length == 0) {
                        query(DDL_CREATE_ROLE_PERMISSION_TABLE, [], errCallback, function () {
                            ...
                            if (doneCallback) doneCallback(result.rows, result, DDL_CREATE_ROLE_PERMISSION_TABLE, ['brtc_role_permission']);
                        });
                    } else {
                        ...
                        query('select * from brtc_role_permission where role_id = \'role_10101\' and permission_id in (\'perm_datasource_create\', \'perm_datasource_read\', \'perm_datasource_delete\', \'perm_datasource_update\')', [], errCallback, function (result) {
                            if (result.length == 0) {
                                var records = [];
                                records.push(['role_10101', 'perm_datasource_create', '', 'Create a datasource']);
                                records.push(['role_10101', 'perm_datasource_read', '', 'Read a datasource']);
                        ...
                        query('select * from brtc_role_permission where role_id = \'role_10101\' and permission_id in (\'perm_deploy_read\', \'perm_deploy_delete\')', [], errCallback, function (result) {
                            if (result.length == 0) {
                                var records = [];
                                records.push(['role_10101', 'perm_deploy_create', '', 'Create a deploy']);
                                records.push(['role_10101', 'perm_deploy_read', '', 'Read a deploy']);
                        ...
                        query('select * from brtc_role_permission where permission_id in (\'perm_publish_create\', \'perm_publish_read\' , \'perm_publish_delete\')', [], errCallback, function (result) {
                            if (result.length == 0) {
                                var records = [];
                                records.push(['role_10101', 'perm_publish_create', '', 'Create a publish']);
                                records.push(['role_10101', 'perm_publish_read', '', 'Read a publish']);
                        ...
                        query('select * from brtc_role_permission where permission_id in (\'perm_repo_shared_create\')', [], errCallback, function (result) {
                            if (result.length == 0) {
                                var records = [];
                        ...
                        query('select * from brtc_role_permission where permission_id in (\'perm_repo_shared_read\')', [], errCallback, function (result) {
                            if (result.length == 0) {
                                var records = [];
                        ...
                        query('SELECT * FROM brtc_role_permission WHERE (role_id = \'role_10103\' OR role_id = \'role_10102\') AND permission_id LIKE \'perm_deploy%\'', [], errCallback, function (result) {
                            if (result.length > 0) {
                                var records = [];
                        ...
                        query('select * from brtc_role_permission where role_id = \'role_10103\' AND permission_id in (\'perm_schedule_read_my\', \'perm_publish_read_my\', \'perm_publish_read\')', [], errCallback, function (result) {
                            if (result.length < 3) {
                                var prev = [], added = [];
                        ...
                        query('select * from brtc_role_permission where role_id = \'role_10103\' AND permission_id in (\'perm_schedule_read\')', [], errCallback, function (result) {
                            if (result.length > 0) {
                                var records = [];
                        ...
                        query('select * from brtc_role_permission where role_id = \'role_10101\' AND permission_id in (\'data_upload_shared\')', [], errCallback, function (result) {
                            if (result.length == 0) {
                                var added = [];
                        ...
                        query('select * from brtc_role_permission where role_id = \'role_10102\' AND permission_id in (\'data_upload_shared\')', [], errCallback, function (result) {
                            if (result.length == 0) {
                                var added = [];
                        ...
                        if (doneCallback) doneCallback(result.rows, result, DDL_CHECK_TABLE, ['brtc_role_permission']);
                    }
                });
            },
