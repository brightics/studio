(function () {
     ...
     *                                 FnUnit
     *************************************************************************/
    Brightics.VA.Core.Functions.Library.queryExecutorPython2 = {
        "category": "script",
        "defaultFnUnit": {
            "func": "queryExecutorPython2",
            "name": "brightics.function.transform$sql_execute2",
            "label": {
                "en": "Fast Query Executor", 
                "ko": "빠른 쿼리 실행기"
            },
            "context": "python",
            "version": "3.6",
...
(function () {
    ...
    Brightics.VA.Core.Functions.Library.queryExecutorPython2.propertiesPanel = queryExecutorPythonProperties;
}).call(this);
/**************************************************************************
 *                               Validator
 *************************************************************************/
...
(function () {
    ...
    Brightics.VA.Core.Functions.Library.queryExecutorPython2.validator = queryExecutorPythonValidator;
}).call(this);