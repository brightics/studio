...
(function () {
    ...
    PublishReportDialog.prototype.getSchedule = function (publishData) {
        ...
        this.$publishGrid.jqxGrid('source', adapter);
        this.$publishGrid.jqxGrid('clearselection');

        this.$headerAera.find('.brtc-admin-total-count').text(this.data.length);
    };
