## Format
Python script editor and executor


## Description
This function returns value for executed Python Script. The python script saves modifications via Jupyter Notebook.

## Properties
1. **Script**<b style='color:red'>*</b>: Python Script
2. **Outputs**: Results generated after executing Python script.
