...
class SubQuery_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.emp = pd.DataFrame({'empno': [7839, 7698, 7782, 7566, 7788, 7902, 7369, 7499, 7521, 7654, 7844, 7876, 7900, 7934],
    ...
    def test04(self):
        ...
        res = self.brtcsql.execute_sql_query(sql)
        ref = pd.DataFrame({
            'ename': ['KING', 'BLAKE', 'CLARK', 'JONES', 'SCOTT', 'FORD', 'ALLEN', 'TURNER', 'MILLER'],
