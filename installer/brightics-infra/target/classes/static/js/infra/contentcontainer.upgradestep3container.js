...
(function () {
    ...
    function UpgradeStep3Container($parent) {
        this.$parent = $parent;
    }

    UpgradeStep3Container.prototype.setController = function (controller) {
        this.controller = controller;
    };

    UpgradeStep3Container.prototype.render = function () {
        this.$parent.empty();
        this.createLayout();
        this.renderContent();
    };

    UpgradeStep3Container.prototype.createLayout = function () {
        this.createHeadArea();
        this.createContArea();
    ...
    UpgradeStep3Container.prototype.createHeadArea = function () {
        this.$headArea = $('' +
    ...
    UpgradeStep3Container.prototype.createContArea = function () {
    ...
    UpgradeStep3Container.prototype.createTabArea = function () {
        this.$tabArea = $('' +
    ...
    UpgradeStep3Container.prototype.createDeployServiceArea = function () {
    ...
    UpgradeStep3Container.prototype.createButtonArea = function () {
        this.$tabArea = $('' +
            '<div class="fix_area ">' +
            '   <div class="btn_wrap">' +
            '       <div class="fl_r">' +
    ...
    UpgradeStep3Container.prototype.renderContent = function () {
        try {
            var $content = $('#content');
    ...
    ServiceDeployManager.prototype.renderContents = function () {
        var _this = this;
        var data = Brightics.Installer.Studio.upgradeInfo.installstep3;
        ...
        for( var pkgIdx in data.packages ) {
            var pkg = data.packages[pkgIdx];
    ...
    root.Brightics.Installer.ContentContainer.UpgradeStep3Container = UpgradeStep3Container;
