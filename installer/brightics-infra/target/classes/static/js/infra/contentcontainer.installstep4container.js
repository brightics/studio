...
(function () {
    ...
    function InstallStep4Container($parent) {
        this.$parent = $parent;
        this.studio = Brightics.Installer.Utils.WidgetUtils.getStudioRef($('.brtc-installer-studio'));
    }

    InstallStep4Container.prototype.setController = function (controller) {
        this.controller = controller;
    };

    InstallStep4Container.prototype.render = function () {
        this.$parent.empty();
        this.createLayout();
        this.renderContent();
    };

    InstallStep4Container.prototype.createLayout = function () {
        this.createHeadArea();
        this.createContArea();
    ...
    InstallStep4Container.prototype.createHeadArea = function () {
        this.$headArea = $('' +
    ...
    InstallStep4Container.prototype.createContArea = function () {
    ...
    InstallStep4Container.prototype.createTabArea = function () {
        this.$tabArea = $('' +
    ...
    InstallStep4Container.prototype.createPackageTabArea = function () {
        this.$packageTabArea = $('' +
    ...
    InstallStep4Container.prototype.createButtonArea = function () {
        this.$tabArea = $('' +
            ...
            '           <button id="install_button" class="btnBigBlue"><span>Install</span></button>' +
            '       </div>' +
            '   </div>' +
            '</div>');
        this.$contArea.append(this.$tabArea);
    ...
    InstallStep4Container.prototype.renderContent = function () {
        try {
            this.renderContents();
    ...
    InstallStep4Container.prototype.renderContents = function () {
        var _this = this;
        ...
        $.ajax({
            ...
            success: function (response) {
                _this.originalData = $.extend(true, {}, response);
                _this.getDataFormat = $.extend(true, {}, response);
                ...
                _this.createServiceConfigurations(_this.getDataFormat, _this.originalData);
    ...
    InstallStep4Container.prototype.renderPackageTab = function () {
        var _this = this;
    ...
    InstallStep4Container.prototype.createServiceConfigurations = function (data, originalData) {
    ...
    InstallStep4Container.prototype.saveCurrentConfiguration = function (selectedPackage) {
        this.serviceConfigurations[selectedPackage].save();
    };

    InstallStep4Container.prototype.renderCurrentConfiguration = function (selectedPackage) {
        this.serviceConfigurations[selectedPackage].render();
    };

    InstallStep4Container.prototype.bindPreviousButtonEvent = function () {
        var _this = this;
    ...
    InstallStep4Container.prototype.validateCongifs = function () {
    ...
    InstallStep4Container.prototype.bindSaveButtonEvent = function () {
        var _this = this;
    ...
    InstallStep4Container.prototype.bindInstallButtonEvent = function () {
        var _this = this;
        ...
        $('.fix_area > .btn_wrap > .fl_r').find('#install_button').on('click', function () {
            if (_this.validateCongifs()) {
                ...
                _this.studio.showPopup({
                    title: 'Install',
                    mode: 'confirm',
                    message: ['Are you sure want to proceed with the installation?'],
                    hasCheckBox: false,
                    checkBoxMessage: '',
                    callback: function (isChecked) {
                        _this.studio.showProgress('Starting Install...');

                        $.ajax({
                            type: 'POST',
                            contentType: 'application/json; charset=utf-8',
                            url: '/api/v1/wizard/installstart',
                            data: JSON.stringify(sendData),
                            success: function (response) {
                                _this.studio.hideProgress();
    ...
    root.Brightics.Installer.ContentContainer.InstallStep4Container = InstallStep4Container;
