...
(function () {
    ...
    function InstallStep1Container($parent) {
        this.$parent = $parent;
    }

    InstallStep1Container.prototype.setController = function (controller) {
        this.controller = controller;
    };

    InstallStep1Container.prototype.render = function () {
        this.$parent.empty();
        this.createLayout();
        this.renderContent();
    };

    InstallStep1Container.prototype.createLayout = function () {
        this.createHeadArea();
        this.createContArea();
    ...
    InstallStep1Container.prototype.createHeadArea = function () {
        this.$headArea = $('' +
    ...
    InstallStep1Container.prototype.createContArea = function () {
    ...
    InstallStep1Container.prototype.createTabArea = function () {
        this.$tabArea = $('' +
    ...
    InstallStep1Container.prototype.createUserInfoArea = function () {
        this.$userInfoArea = $('' +
            '<div class="row-fluid">' +
    ...
    InstallStep1Container.prototype.createHostNameArea = function () {
        this.$hostNameArea = $('' +
    ...
    InstallStep1Container.prototype.createButtonArea = function () {
        this.$buttonArea = $('' +
            '<div class="fix_area ">' +
            '   <div class="btn_wrap">' +
            '       <div class="fl_l">' +
            '           <button class="btnBigWhite"><span>Default Install</span></button>' +
            '           <div class="fix_area_des"><span><img src="static/images/des_info.gif"> It can be installed with default settings.</span></div>' +
            '       </div>' +
            '       <div class="fl_r">' +
    ...
    HostNameListManager.prototype.bindDefaultInstallButtonEvent = function () {
        var _this = this;

        //POST /api/v1/hosts/default
        $('.fix_area > .btn_wrap > .fl_l > .btnBigWhite').on('click', function () {
            ...
            if (validation.passValidation) {
                _this.studio.showPopup({
                    ...
                    mode: 'confirm',
                    message: ['The Brightics is installed by default.', 'Are you sure want to proceed?'],
                    hasCheckBox: false,
                    checkBoxMessage: '',
                    callback: function (isChecked) {

                        _this.studio.showProgress('Starting Default Install...');

                        $.ajax({
                            type: 'POST',
                            contentType: 'application/json; charset=utf-8',
                            url: '/api/v1/wizard/defaultinstall',
                            data: JSON.stringify(_this.createSendData()),
    ...
    root.Brightics.Installer.ContentContainer.InstallStep1Container = InstallStep1Container;
