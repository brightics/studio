...
(function () {
    ...
    function InstallStep2Container($parent) {
        this.$parent = $parent;
        this.studio = Brightics.Installer.Utils.WidgetUtils.getStudioRef($('.brtc-installer-studio'));
    }

    InstallStep2Container.prototype.setController = function (controller) {
        this.controller = controller;
    };

    InstallStep2Container.prototype.render = function () {
        this.$parent.empty();
        this.createLayout();
        this.renderContent();
    };

    InstallStep2Container.prototype.createLayout = function () {
        this.createHeadArea();
        this.createContArea();
    ...
    InstallStep2Container.prototype.createHeadArea = function () {
        this.$headArea = $('' +
    ...
    InstallStep2Container.prototype.createContArea = function () {
    ...
    InstallStep2Container.prototype.createTabArea = function () {
        this.$tabArea = $('' +
    ...
    InstallStep2Container.prototype.createServiceListArea = function () {
        var _this = this;
    ...
    InstallStep2Container.prototype.createExternalPackageDialog = function (packageList) {
        var _this = this;
    ...
    InstallStep2Container.prototype.createButtonArea = function () {
        this.$tabArea = $('' +
            '<div class="fix_area ">' +
            '   <div class="btn_wrap">' +
            '       <div class="fl_r">' +
    ...
    InstallStep2Container.prototype.renderContent = function () {
        try {
            var $content = $('#content');
    ...
    root.Brightics.Installer.ContentContainer.InstallStep2Container = InstallStep2Container;
