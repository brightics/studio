...
(function () {
    ...
    function InstallProgressHome($parent) {
    ...
    InstallProgressHome.prototype.init = function ($parent) {
        this.STATUS = {
            failed: {
    ...
    InstallProgressHome.prototype.initTitle = function () {
        this.$titleArea = $('' +
            ' <div class="h2_title"><span>Install Progress</span></div>' +
            ' <div class="location">' +
            '   <a href="#">Installer</a> <img src="static/images/ico_path.gif" alt="" /> <strong>Install Progress</strong>' +
            ' </div>');
        this.$parent.append(this.$titleArea);
    };

    InstallProgressHome.prototype.initContentArea = function () {
    ...
    InstallProgressHome.prototype.initTabs = function () {
        var _this = this;
        var $tabContainer = $('' +
...
//            if (tabList.index(thisTab) == 0) {
    ...
    InstallProgressHome.prototype.arrangeTab = function (index) {
    ...
    InstallProgressHome.prototype.initTabPageContainer = function () {
        var tabPageTemplate =
    ...
    InstallProgressHome.prototype.addEventConsoleLogButton = function () {
        var _this = this;
    ...
    InstallProgressHome.prototype.renderPrepareTable = function () {

    };

    InstallProgressHome.prototype.renderServicesTab = function () {
        var _this = this;
    ...
    InstallProgressHome.prototype.setEstimatedTme = function (serviceCount) {
        var estimatedTime = ' 10 min';

        this.$estimatedTime.text(estimatedTime);
    };

    InstallProgressHome.prototype.renderServicesTable = function () {
        var _this = this;
        $.ajax({
            method: 'GET',
            crossDomain: true,
            ...
            success: function (response) {
                ...
                if (response.hosts && response.hosts.length > 0) {
                    ...
                    if (response.hosts[0].status.toLowerCase() == 'preparing') {
                        _this.studio.showProgress('install preparing...');
                    } else {
                ...
                if (!isInstalling) {
                    ...
                    if (doneStatus == 'failed') {
                        ...
                        if (_this.studio.installType === 'service') {
                            ...
                            studio.setSideMenuEnable('INSTALL_FAILED');
                        }
    ...
    InstallProgressHome.prototype.renderPackageTab = function (packageName) {
        var _this = this;
    ...
    InstallProgressHome.prototype.renderPackageTable = function (packageName) {
        var _this = this;
    ...
    InstallProgressHome.prototype.initProcessingViewer = function () {
         var option = {
    ...
    root.Brightics.Installer.ContentContainer.InstallProgressHome = InstallProgressHome;
