package com.samsung.sds.brightics.common.workflow.runner.job.model.impl;
...
import com.samsung.sds.brightics.common.workflow.runner.util.opt.OptScriptUtil;
...
public abstract class OptWorkflow extends SequentialWorkflow {
	...
	private Object runPythonScriptTask(String script) {
		...
		try {
			...
			// executeTask
			JobContextHolder.getJobRunnerAPI().executeTask(
					taskId, "Python", buildAttributes().toString(), params.toJsonString());
