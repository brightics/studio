...
public class ParquetFileReader implements Closeable {
   ...
   * selected column validation before hear
   * @param filteredColumns
   * @return
   * @throws IOException
   */
	public PageReadStore readNextRowGroup(int[] filteredColumns) throws IOException {
		...
		for (int i : filteredColumns) {
			ColumnChunkMetaData mc = columns.get(i);
