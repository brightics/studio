...
public enum ContextType
   ...
   * <code>DLPYTHON = 4;</code>
   */
  public static final int DLPYTHON_VALUE = 4;
  ...
  private static final ContextType[] VALUES = {
    SCALA, PYTHON, FILESYSTEM, REDIS, KV_STORE, DLPYTHON, 
  };
  ...
  private ContextType(int index, int value) {
    this.index = index;
    this.value = value;
  }
