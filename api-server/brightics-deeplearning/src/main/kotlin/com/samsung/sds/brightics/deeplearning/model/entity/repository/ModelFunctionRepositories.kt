...
@Transactional
interface ModelFunctionRepository : BrtcRepository<BrtcDlModelFunction, String> {

    @Query("SELECT DISTINCT tags FROM BrtcDlModelFunction model JOIN model.tags tags")
    fun findDistinctTags(): Iterable<String>
}