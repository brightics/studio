...
@Transactional
interface InputFunctionRepository : BrtcRepository<BrtcDlInputFunction, String> {

    @Query("SELECT DISTINCT tags FROM BrtcDlInputFunction input JOIN input.tags tags")
