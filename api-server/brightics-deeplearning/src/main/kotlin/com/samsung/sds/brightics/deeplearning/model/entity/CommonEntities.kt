...
@Entity
class BrtcDlUserDefinedFunction(label: String, udfType: String, tags: List<String>, description: String, content: String, image: String, creator: String, createTime: String, updater: String, updateTime: String, id: String = "") {
        var label: String = label
        @JsonIgnore var udfType: String = udfType
        ...
        @Transient var type: String = ""
                get() = RepoType.DB_UDF
        @Id @GeneratedValue(generator = "user_defined_function")
        @GenericGenerator(name = "user_defined_function"
                , parameters = [Parameter(name = "prefix", value = "uf")]
