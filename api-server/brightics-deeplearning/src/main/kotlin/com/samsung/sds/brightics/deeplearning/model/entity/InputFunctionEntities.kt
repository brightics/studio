...
@Entity
class BrtcDlInputFunction(label: String, tags: List<String>, description: String, content: String, image: String, creator: String, createTime: String, updater: String, updateTime: String, id: String = "") {
        ...
        @Id @GeneratedValue(generator = "input_function")
        @GenericGenerator(name = "input_function"
                , parameters = [Parameter(name = "prefix", value = "if")]
